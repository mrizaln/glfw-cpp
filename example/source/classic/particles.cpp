...
static void draw_particles(glfw_cpp::Window& window, double t, float dt)
{
...
static void draw_scene(glfw_cpp::Window& window, double t)
{
...
{
    auto* window = (glfw_cpp::Window*)arg;
